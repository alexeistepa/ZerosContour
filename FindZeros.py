...
def ver_cont(z0,h,g):
    ...
    return 1j*(quad(realfixreal,0,h,epsabs = 0.05, limit=200)[0] + 1j*quad(imagfixreal,0,h,epsabs = 0.05, limit=200 )[0]) # SPEED: Can introduce tolerence limit here
...
def hor_cont(z0,h,g):
    ...
    return quad(realfiximag,0,h,epsabs = 0.05, limit=200)[0] + 1j*quad(imagfiximag,0,h,epsabs = 0.05, limit=200)[0] # SPEED: Can introduce tolerence limit here
